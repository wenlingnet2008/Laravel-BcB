            ...
            <div class="row">
                ...
                <div class="col-md-12 col-xs-12">
                    ...
                    <div class="white-box">
                        ...
                        <form class="form-horizontal" method="post" action="{{ route('admin.categories.update', ['catid'=>$category['catid']]) }}">
                            {{ csrf_field() }}
                            {{ method_field('PUT') }}
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-12">
                                    <input type="text" class="form-control" value="{{$category['name']}}" name="name"> </div>
                            </div>
