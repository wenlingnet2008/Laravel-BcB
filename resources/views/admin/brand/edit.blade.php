                    ...
                    <div class="white-box">
                        ...
                        <div class="row">
                            <div class="col-sm-12 col-xs-12">
                                ...
                                <form class="form-horizontal" method="post" action="{{ route('admin.brands.update', ['brandid'=>$brand['brandid']]) }}" enctype="multipart/form-data">
                                    {{ csrf_field() }}
                                    {{ method_field('PUT') }}
                                    <div class="form-group">
                                        <label class="col-md-12">品牌名称</label>
                                        <div class="col-md-12">
                                            <input type="text" name="name" class="form-control" placeholder="" value="@if(isset($brand)){{ $brand['name'] }}@endif">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-4">
                                            <input type="file" id="input-file-now" name='thumb' class="dropify"
                                                   data-height="100" data-max-file-size="2M" data-default-file="@if(isset($brand)){{ asset('storage/'.$brand['thumb']['thumb1']) }}@endif"/>
                                        </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <textarea class="textarea_editor form-control" name="content" rows="15" placeholder="">@if(isset($brand)){{ $brand['content'] }}@endif</textarea>
                                        </div>
                                    </div>
